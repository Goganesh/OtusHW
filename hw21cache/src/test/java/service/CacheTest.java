...
import ru.otus.homework.cache.Listener;
...
class CacheTest {
    ...
    //Проверка, что после сборки мусора выполнилась очистка WeakReference, а вслед за ней удаление "пустышек" WeakReference.
